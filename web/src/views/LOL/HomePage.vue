    ...
    export default {
        ...
        data() {
            return {
                ...
                //轮播图数据
                banners: [require("../../assets/LOL/53efa127918d462ccbf26881fc922fdb.820x340.jpg"),
                require('../../assets/LOL/7c103c2adc778e2681a2057d57c6b8ff.820x340.jpg'),
                require('../../assets/LOL/a1fe00fe2224e00785d2f347930b6949.jpg')],
                swiperOption: {
                    pagination: {
                        el: '.pagination-home'
                    },
